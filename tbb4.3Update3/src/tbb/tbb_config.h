...
#if __GXX_EXPERIMENTAL_CXX0X__ && !defined(__EXCEPTIONS) && ((!__INTEL_COMPILER && !__clang__ && (__TBB_GCC_VERSION    >=40400 && __TBB_GCC_VERSION    <40600)) || (__INTEL_COMPILER<=1400 && (__TBB_GCC_VERSION    >=40400 && __TBB_GCC_VERSION    <=40801)))
