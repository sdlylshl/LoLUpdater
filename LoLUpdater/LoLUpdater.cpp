	...
	LPSTR lpCmdLine, int nCmdShow)
{
	...
	pathcontainer[0] << (static_cast<LPWSTR>(&cwd[0])[0] + std::wstring(L":Program Files"));
	...
	wchar_t cgglbin[MAX_PATH] = L"";
	wchar_t* cgglbin1;
	cgglbin1 = cgglbin;
	wchar_t* cggl = L"CgGL.dll";
	wchar_t asd232[MAX_PATH] = L"";
	...
	wchar_t cgd3d9bin[MAX_PATH] = L"";
	wchar_t* cgd3d9bin1;
	cgd3d9bin1 = cgd3d9bin;
	wchar_t* cgd3d9 = L"CgD3D9.dll";
	wchar_t asd2322[MAX_PATH] = L"";
	...
	wprintf(tbb1);
#endif
	wchar_t airdest[MAX_PATH] = L"";
	wchar_t* airdest1;
	airdest1 = airdest;

	wchar_t asdcc[MAX_PATH] = L"";
	...
	wchar_t flashdest[MAX_PATH] = L"";
	wchar_t* flashdest1;
	flashdest1 = flashdest;

	wchar_t asdccddqq[MAX_PATH] = L"";
	...
	wchar_t flashlatest[MAX_PATH] = L"";
	wchar_t* flashlatest1;
	flashlatest1 = flashlatest;

	wchar_t asdccddqqqq[MAX_PATH] = L"";
	...
	wchar_t asd2ccqqqqqq[MAX_PATH] = L"";
	...
	wchar_t cgdest[MAX_PATH] = L"";
	wchar_t* cgdest1;
	cgdest1 = cgdest;

	wchar_t asdccddqqqqqq[MAX_PATH] = L"";
	...
	wchar_t asd2ccqqqqqqqq[MAX_PATH] = L"";
	...
	wchar_t cggldest[MAX_PATH] = L"";
	wchar_t* cggldest1;
	cggldest1 = cggldest;

	wchar_t asdccddqqqqqqqq[MAX_PATH] = L"";
	...
	wchar_t asd2ccqqqqqqqqqq[MAX_PATH] = L"";
	...
	wprintf(cggldest);
#endif
	wchar_t cgd3d9dest[MAX_PATH] = L"";
	wchar_t* cgd3d9dest1;
	cgd3d9dest1 = cgdest;

	wchar_t asdccddqqqqqqqqw[MAX_PATH] = L"";
	...
	wchar_t asd2ccqqqqqqqqqqa[MAX_PATH] = L"";
