          ...
          my_dst_tsc(0),
				...
				bool check_for_demand(task& t)
				{
					if (pass == my_delay)
					{
						...
						else if (my_divisor && my_max_depth)
						{ // make balancing task
...
#pragma warning( pop )
	...
	private:
		template <typename Range, typename Body, typename Partitioner>
		friend class serial::interface7::start_for;
		template <typename Range, typename Body, typename Partitioner>
		friend class interface7::internal::start_for;
		template <typename Range, typename Body, typename Partitioner>
		friend class interface7::internal::start_reduce;
		template <typename Range, typename Body, typename Partitioner>
