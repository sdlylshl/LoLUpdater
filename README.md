...
The adobe air/flash files are installed by downloading the latest adobe air beta installeer (url has to be changed manually from code), currently using [Adobe Air Beta 17](http://labs.adobe.com/downloads/air.html)
