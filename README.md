...
The adobe air/flash files are installed by downloading the latest adobe air beta installed (url has to be changed manually from code), currently using [adobe air beta 17](http://labs.adobe.com/downloads/air.html)
